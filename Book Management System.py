...
class LoginScreen:
    ...
    def create_login_widgets(self):
        ...
        self.username_label = tk.Label(self.login_frame, text="Username:", font=("Arial", 10, "bold"), bg="#ffffff")
        ...
        self.username_entry.pack(pady=2, ipadx=2, ipady=4)

        # Password label and entry
        self.password_label = tk.Label(self.login_frame, text="Password:", font=("Arial", 10, "bold"), bg="#ffffff")
        ...
        self.password_entry.pack(pady=2, ipadx=2, ipady=4)
...
class BookManagementSystem:
    ...
    def view_books(self):
        ...
        try:
            ...
            if books:
                for book in books:
                    books_listbox.insert(tk.END, f"{book[0]} by {book[1]} ({book[2]})")
            else:
